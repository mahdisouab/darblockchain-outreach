...
const approved = (cutsDoc.cuts ?? cutsDoc).filter((c) => Number.isFinite(Number(c.start)) && Number.isFinite(Number(c.end)) && c.end > c.start);
if (approved.length === 0) die("no valid cuts in --cuts file");
