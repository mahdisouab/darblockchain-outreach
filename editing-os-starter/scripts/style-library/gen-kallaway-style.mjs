...
// Resolved relative to this file so the generator runs from any checkout location.
const ROOT = resolve(dirname(fileURLToPath(import.meta.url)), "../../style-library/02-kallaway");
