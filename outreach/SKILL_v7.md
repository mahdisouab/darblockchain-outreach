...
description: Daily automated outreach pipeline v7 (conversion-optimized). Targets student associations crypto/tech & bootcamps as priority (fastest conversion cycle), universities as long-term pipeline. 4-bloc email structure (90-120 words), 3-bloc LinkedIn messages (50-70 words). Proven formats from BSA EPFL, Le Wagon, Kryptosphere, Polytech conversions. FR/EN by country.
---

# Dar Blockchain — Daily Outreach Pipeline (v7 — Conversion-Optimized)
...
3. **"Ouvert à en discuter ?"** > "Seriez-vous disponible ?" (lower pressure)
...
**PRIORITY A — Associations étudiantes crypto/tech & bootcamps (at least 40% of leads):**
These convert FASTEST (hours, not weeks). Search AGGRESSIVELY for them.
...
- **One CTA only**: "15-20 minutes pour un court échange ?" (with time frame) or "Ouvert à en discuter ?" (for LinkedIn follow-ups)
...
**Bloc 4 — CTA précis** (1 phrase + lien):
- "Auriez-vous 15-20 minutes pour un court échange ?" — giving a time frame is better than vague "disponible"
...
Je serais ravi d'explorer avec vous les modalités d'un partenariat adapté à l'UNIL. Auriez-vous 15-20 minutes pour un court échange ?
...
**Bloc 3 — CTA Calendly** (1 phrase): "Ouvert à en discuter ? calendly.com/souebmahdi/new-meeting" — Low pressure. One link only. No other URLs.
...
- **"Ouvert à en discuter ?"** — this exact CTA, not "Seriez-vous disponible ?" (lower pressure, proven)
...
- **Always target named people, not institutional pages** — contacting a page adds 1-2 hops before reaching a decision-maker. If the only LinkedIn available is a page, search harder for a named person.
...
15b. **LEAD MIX TARGET**: at least 40% of daily leads should be associations étudiantes crypto/tech or bootcamps. These are the fastest converters.
