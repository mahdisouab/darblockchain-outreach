...
description: Daily automated outreach pipeline v8 (conversion-optimized + structured segmentation). Targets student associations crypto/tech & bootcamps as priority (fastest conversion cycle), universities as long-term pipeline. 4-bloc email structure (90-120 words), 3-bloc LinkedIn messages (50-70 words). Structured segment x country rotation (2-3 day blocks). 3-day booking urgency in CTAs. Pre-call reminder workflow. Proven formats from BSA EPFL, Le Wagon, Kryptosphere, Polytech conversions. FR/EN by country.
---

# Dar Blockchain — Daily Outreach Pipeline (v8 — Conversion-Optimized + Structured Segmentation)
