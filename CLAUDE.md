...
- Setup: `npm install`, then `npx hyperframes doctor` (needs Node 20+, FFmpeg, Chrome,
  ...
  double-click `editing-os-starter/scripts/setup_windows.bat` (winget for Node/FFmpeg/Chrome/Python,
  whisper.cpp prebuilt zip, PATH, npm install), then the launcher
